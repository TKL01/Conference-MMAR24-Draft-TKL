...
\section{Conclusion}
This work has aimed to develop a web-based application that facilitates user interaction with the Husky robot. The primary objectives include providing an intuitive graphical interface for comprehending the robot's internal mechanisms and environmental context, as well as enabling versatile control over its movement. 
Notably, compatibility considerations extend to diverse devices with web connectivity, irrespective of their origin or browser specifications. The application integrates a database, enabling users to monitor and derive informed decisions from real-time robot data. 
...
\bibitem{webvideoserver}"web\_video\_server," ROS, http://wiki.ros.org/web\_video\_server (accessed March 20, 2024).
...
\bibitem{keyboardteleopjs}"keyboardteleopjs," keyboardteleopjs - ROS Wiki, http://wiki.ros.org/keyboardteleopjs (accessed March 22, 2024).
\bibitem{zed}"ZED 2," StereoLabs*, https://www.stereolabs.com/products/zed-2 (accessed March 22, 2024).
...
\bibitem{jinja}"Template Designer Documentation," Template Designer Documentation - Jinja Documentation, https://jinja.palletsprojects.com/en/3.0.x/templates/ (accessed March 22, 2024).
\bibitem{opcua}"Unified Architecture," Unified Architecture - OPC Foundation, https://opcfoundation.org/about/opc-technologies/opc-ua/ (accessed March 22, 2024).
...
\bibitem{django}"Django makes it easier to build better web apps more quickly and with less code.," The web framework for perfectionists with deadlines., https://www.djangoproject.com/ (accessed March 22, 2024).
\end{thebibliography}
\vspace{12pt}
