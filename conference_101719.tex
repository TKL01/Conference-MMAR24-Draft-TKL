...
Fig. \ref{fig:loop} illustrates the general idea of the data loop between the Husky UGV robot and the web application. !!MEHR AUSFÜHREN!!
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8.9cm]{Pictures/galaxysurface.jpg}}
    \caption{Galaxy S23 mobile view on the left and Surface Pro (5th Gen.) view on the right. [BILD WIRD NOCH VERBESSERT, S. UNTERER ABSTAND]}
